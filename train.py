...
Usage:
    # Train on 16×16 grid with global vision
    python train.py --algorithm qlearning --episodes 5000 --run-name ql_16x16_global
    ...
    python train.py --algorithm qlearning --episodes 3000 \
        --load-model models/ql_16x16_global/checkpoint_ep2000.pkl --run-name ql_continued
