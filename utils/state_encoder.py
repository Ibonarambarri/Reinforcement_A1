...
- Agent position: 196 positions (14×14 interior grid, excluding border walls)
- Door position: 196 positions (14×14 interior grid, excluding border walls)
...
class StateEncoder:
    ...
    Attributes:
        ...
        interior_size (int): Size of interior (14×14, excluding border walls)
